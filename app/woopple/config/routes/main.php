...
return array_merge(
    require 'admin.php', require 'json.php', [
        ...
        '/hr/departments/add' => 'admin/department/add-department',
        '/hr/departments/modify/<id>' => 'admin/department/modify-department',
        '/hr/departments/remove/<id>' => 'admin/department/remove-department',
